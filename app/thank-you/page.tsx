...
const ThankYouPage = async ({searchParams}: ThankYouPageProps) => {
    ...
    if(orderUserId !== user?.id)
        return redirect(`/signin?origin=thank-you?orderId=${orderId}`)
  ...
  return (
    <main className="relative lg:min-h-full">
        ...
        <div>
            <div className="mx-aut max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
                <div className="lg:col-start-2">
                    <p className="text-sm font-medium text-blue-600">Order Successfull</p>
                    <h1 className="mt-2 text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl">Thanks for ordering</h1>
                    { order._isPaid ? 
                    ...
                    <p className="mt-2 text-base text-muted-foreground">
                        We apreciate your order, we&apos;re currently processing it. So hang tight and we&apos;ll send you confirmation very soon!
                    </p> }
                                    ...
                                    className="flex space-x-6 py-6">
                                        ...
                                        <div className="flex-auto flex flex-col justify-between">
                                            ...
                                            {order._isPaid ? (
                                                ...
                                                className="text-blue-600 hover:underline underline-offset-2">Download asset</a>
                                            ): null}
                                        </div>
                  ...
                  <p className='text-base'>
                    {formatPrice(orderTotal + fee)}
                            ...
                            <div className="mt-16 border-t border-gray-200 py-6 text-right">
                                ...
                                href="/products">Continue Shopping &rarr;</Link>
                            </div>
                    </div>
                </div>
            </div>
