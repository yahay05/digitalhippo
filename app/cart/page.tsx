                ...
                <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                                ...
                                return(
                                    <li key={product.id} className="flex py-6 sm:py-10">
                                        ...
                                        <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                                            <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                                ...
                                                <div className="flex justify-between">
                                                    <h3 className="text-sm">
                                                        ...
                                                        className="font-medium text-gray-700 hover:text-gray-800">{product.name}</Link>
                                                    </h3>
                                                </div>
                                            ...
                                            <p className="mt-3 space-x-2 flex text-sm text-gray-700">
                    ...
                    <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
                        ...
                        <div className="mt-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                                ...
                                <div className="text-base font-medium text-gray-900">
                                    {isMounted ? formatPrice(fee + cartTotal) : <Loader2 className="h-4 w-4 animate-spin text-muted-foreground" 
                                    />}
                                </div>
                            </div>
                        </div>
                        <div className="mt-6">
                            ...
                            className="w-full" size="lg">Checkout 
                            {isLoading ? <Loader2 className="h-4 w-4 ml-1.5 animate-spin"/> : null}
                            </Button>
                        </div>
                    </section>
                </div>
